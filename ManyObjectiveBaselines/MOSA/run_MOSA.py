...
from MOBaselines.MOSA import MOSA
import sys
import argparse
...
def main():
    ...
    MOSA.MOSA.main(reduced_input_path=reduced_input_path, Subclass_file_path=Subclass_file_path, cost_path=cost_path, time_budget= time_budget)
